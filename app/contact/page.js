    ...
    <section className='flex flex-col'>
      ...
      <div className='flex justify-center md:justify-between w-[70%] mx-auto gap-4'>
        <div className='flex flex-col gap-8 items-center justify-between py-8 font-heading text-3xl font-bold max-h-80'>
          <Link href="tel:+17087699451" className='contact-button'>708-769-9451</Link>
          <Link href='https://www.facebook.com/Petservicesinelmwoodpark' className='contact-button'>
            <FaFacebook />
          </Link>
          <Link href="mailto:kelleypetlover@gmail.com" className='contact-button'>kelleypetlover@gmail.com</Link>
        </div>
