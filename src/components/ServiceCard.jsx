...
const ServiceCard = ({id, type, img, duration, price, features, cheaper, index}) => {
  ...
  return (
    <div className='flex justify-between my-8' id={id}>
      ...
      {index % 2 === 0 ? (
        <>
          <div className='flex flex-col justify-evenly items-center gap-8'>
            ...
            <div className='w-[470px] h-[450px] relative bg-gradient-to-r from-primary to-secondary p-1 rounded-md'>
              <div className='bg-primary-light h-full rounded-md flex flex-col justify-between'>
                {/* grid for header */}
                <div className='grid grid-cols-2 gap-4 font-semibold font-heading capitalize text-xl w-full mx-auto justify-items-center py-8'>
                  <p>⏱duration</p>
          ...
          <div className='h-[630px] w-[570px]'>
            <img src={img} alt="dogs" className='object-cover h-full w-full transform scale-x-[-1] z-0 rounded-2xl'/>
          </div>
        </>
      ) : (
        <>
